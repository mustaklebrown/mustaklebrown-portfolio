...
export default function SignUpPage() {
    ...
    return (
        <div className="min-h-screen grid items-center justify-center p-6 bg-surface-bg relative overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-accent-tertiary/10 blur-[120px] rounded-full translate-y-1/2 -translate-x-1/2" />
            ...
            >
                <div className="glass-deep p-10 rounded-[40px] border border-white/5 shadow-2xl space-y-8">
                    <div className="space-y-2 text-center">
                        ...
                        >
                            <Image src="/logo.png" width={50} height={50} alt="Mustak Lebrown" className="w-full h-full object-contain" />
                        </motion.div>
                        <h1 className="text-3xl font-extrabold tracking-tight text-surface-text">
                            Join the <span className="text-gradient-brand">Space</span>
                        </h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <Button
                            type="submit"
                            disabled={loading}
                            className="w-full h-12 bg-gradient-to-r from-accent-primary via-accent-secondary to-accent-tertiary hover:opacity-90 text-white font-bold rounded-2xl shadow-lg shadow-accent-primary/20 transition-all active:scale-[0.98]"
                        >
                            {loading ? (
                    ...
                    <div className="pt-4 text-center">
                        <p className="text-surface-muted text-xs font-medium">
                            ...
                            <Link href="/sign-in" className="text-accent-primary font-bold hover:underline">
                                Sign in here
                            </Link>
                        </p>
                    </div>
